...
hiccup_root = '/pscratch/sd/z/zhang73/GitTmp/SourceCode/HICCUP'

# Specify output atmosphere horizontal grid
RRMgrid='WP10ne32x32v1'
dst_horz_grid = f'highorder_{RRMgrid}'
...
data_root = '/pscratch/sd/z/zhang73/DATA/data_hiccup/2014-10/'
...
hiccup_data = hiccup.create_hiccup_data(src_data_name='ERA5',
                                        ...
                                        topo_file=f'/global/cfs/cdirs/e3sm/zhang73/grids2/{RRMgrid}/GTOPO30_{RRMgrid}np4pg2_x6t.nc',
...
if create_map_file :
    ...
    hiccup_data.dst_grid_file = f'/global/cfs/cdirs/e3sm/zhang73/grids2/{RRMgrid}/{RRMgrid}.g'
    hiccup_data.map_file      = f'/global/cfs/cdirs/e3sm/zhang73/grids2/{RRMgrid}/map_ERA5_721x1440_to_{RRMgrid}np4.TRhighorder.20250322.nc'
