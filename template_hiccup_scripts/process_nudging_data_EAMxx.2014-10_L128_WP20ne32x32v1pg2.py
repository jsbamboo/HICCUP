...
beg_date = datetime.datetime.strptime('20141001', '%Y%m%d')
end_date = datetime.datetime.strptime('20141015', '%Y%m%d')
...
dst_horz_grid = f'mono_{RRMgrid}pg2'   
...
src_data_root = f'/pscratch/sd/z/zhang73/DATA/data_hiccup/ERA5_pres_newcds/2014/'
dst_data_root = f'/global/cfs/cdirs/e3sm/zhang73/nudging.UVTQ/{dst_vert_grid}.{dst_horz_grid}.UVTQ.pres.cdsnew.240929/'
...
for t in datetime_list:
    ...
    if create_map_file and not map_file_created:
        ...
        hiccup_data.dst_grid_file = f'/global/cfs/cdirs/e3sm/zhang73/grids2/{RRMgrid}/{RRMgrid}pg2.g'
        hiccup_data.map_file      = f'/global/cfs/cdirs/e3sm/zhang73/grids2/{RRMgrid}/map_ERA5_721x1440_to_{RRMgrid}pg2.TRaave.20250322.nc'
    # --------------------------------------------------------------------------
